...
namespace NI.Data {
	...
	/// </summary>
	/// <remarks>
	/// SimpleStringTemplate replaces all tokens started with '@' (token name should have only aphanumeric or '_-' chars). 
	...
	/// <example>
	/// <code>
	/// var strTpl = new SimpleStringTemplate("@Name[Hello, {0}; Hi all]!");
