...
namespace NI.Data.Dalc.OleDb
{
	/// <summary>
	/// OleDbAdapterWrapper.
	/// </summary>
	public class OleDbAdapterWrapper : IDbDataAdapterWrapper
	{
		...
		public OleDbAdapterWrapper(OleDbDataAdapter adapter)
		{
			_Adapter = adapter;
			// Catch adapter events
			adapter.RowUpdating += new OleDbRowUpdatingEventHandler(this.rowUpdating);
			adapter.RowUpdated  += new OleDbRowUpdatedEventHandler(this.rowUpdated);
		}
