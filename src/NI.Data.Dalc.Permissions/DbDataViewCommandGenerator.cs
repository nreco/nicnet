...
namespace NI.Data.Dalc.Permissions
{
	/// <summary>
	/// </summary>
	public class DbDataViewCommandGenerator : NI.Data.Dalc.DbDataViewCommandGenerator
	{
		...
		protected override string BuildWhereExpression(IDbSqlBuilder dbSqlBuilder, IDbDataView dataView, IQuery query) {
			...
			IQueryNode permissionCondition = DalcConditionComposer.Compose(ContextSubject, DalcOperation.Retrieve, m.Groups["sourceName"].Captures[0].Value);
