...
namespace NI.Data.Dalc.Odbc
{
	...
	/// OleDbAdapterWrapper.
	/// </summary>
	public class OdbcAdapterWrapper : IDbDataAdapterWrapper
	{
		...
		public OdbcAdapterWrapper(OdbcDataAdapter adapter)
		{
			_Adapter = adapter;
			// Catch adapter events
			adapter.RowUpdating += new OdbcRowUpdatingEventHandler(this.rowUpdating);
			adapter.RowUpdated  += new OdbcRowUpdatedEventHandler(this.rowUpdated);
		}
		...
		private void rowUpdated(object sender, OdbcRowUpdatedEventArgs e) {
