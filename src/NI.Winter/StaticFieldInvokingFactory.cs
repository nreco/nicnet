...
namespace NI.Winter {
	...
	/// </summary>
	/// <example><code>
	/// &lt;component name="datetimenow" type="NI.Winter.StaticFieldInvokingFactory,NI.Winter" singleton="false" lazy-init="true"&gt;
	///		&lt;property name="TargetType"&gt;&lt;type&gt;System.DBNull,Mscorlib&lt;/type&gt;&lt;/property&gt;
	///		&lt;property name="TargetField"&gt;&lt;value&gt;Value&lt;/value&gt;&lt;/property&gt;
	/// &lt;/component&gt;
	/// </code></example>
	public class StaticFieldInvokingFactory : Component, IFactoryComponent {
		Type _TargetType;
		string _TargetField;
